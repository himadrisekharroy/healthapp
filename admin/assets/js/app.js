var App = function () {
    ...
    var footerText='2020 &copy; HEALTH APPLICATION Admin.';
      footerText +='<div class="span pull-right">';
      footerText +='<span class="go-top"><i class="icon-angle-up"></i></span>';
      footerText +='</div>';
    ...
    var handleSidebarToggler = function () {
		...
		$('#searchMenuText').keyup(function(){	
			var searchMenuText = $(this).val();
			if(searchMenuText == "")
			{
				$('.page-sidebar ul li').each(function(i)
				{
					$(this).show();
				})
			}
			else
			{
				...
				{ 
					...
					var menuTitle = $(this).find('span.title').html()
					if(menuTitle) 
						{
							menuTitle = menuTitle.toLowerCase();
							var indx = menuTitle.indexOf(searchMenuText);
							if(  indx > -1)
							{
								$(this).show();
							}
						   console.log(menuTitle+" =="+ searchMenuText+"==="+indx); // This is your rel value
						}
				});
			}
		});
    ...
    var handleLoginForm = function () {
        ...
        $('.login-form').validate({
            ...
            submitHandler: function (form) {
                ...
                var loginRemember = 0;
                if(getCookie('remember')) loginRemember = 1;

				$.post( api_url + "/admin_login.php", 
                    { 
                        func:"login", 
					...
					.done(function( data ) {
						...
						{
							//alert("succ");
							window.sessionStorage.admin_id = data.admin_id;	
							window.sessionStorage.admin_name = data.admin_name;						
							...
							if ($('#remember').is(":checked"))
							{
								...
								document.cookie =  "username="+ $("#username").val() +";" + expires + ";path=/";
								document.cookie =  "password="+ $("#password").val() +";" + expires + ";path=/";
								document.cookie =  "remember=1;" + expires + ";path=/";
							}
							else
							{
							...
							$("#login_error").removeClass('hide').removeClass('alert-error').addClass('alert-success');						
							$("#login_error span").html(data.msg);
							setTimeout(function(){
								window.location.href = site_url+ admin_url+"index.html";
							}, 2500);
						}
						else
						{
                            if(data.is_otp)
                            {
                                $("#passcode_container").removeClass('hide');
        ...
        $('.forget-form').validate({
            ...
            submitHandler: function (form) {
				...
				$.post( api_url + "/sd_admin_forgot_pass.php", { func:"forgot_admin", email: $("#forgot_email").val()})
					.done(function(data){
						//alert(data);
						data = JSON.parse(data);
						if(data.success)
						{
							$("#forget_error").removeClass('hide').removeClass('alert-error').addClass('alert-success');						
							$("#forget_error span").html(data.msg);
						}
						else
						{
							$("#forgot_submit").prop( "disabled", false );
							$("#forget_error").removeClass('hide');						
							$("#forget_error span").html(data.msg);
						}
					})
            }
        ...
        $('.register-form').validate({
            ...
            submitHandler: function (form) {				
				...
				$.post( api_url + "/sd_admin_register.php", { func:"register_by_user", register_username: $("#register_username").val(), register_password:$("#register_password").val(), register_email: $("#register_email").val()})
					.done(function( data ) {						
						data = JSON.parse(data);
						if(data.success)
						{
							...
							$("#registration_error").removeClass('hide').removeClass('alert-error').addClass('alert-success');						
							$("#registration_error span").html(data.msg);
							
						}
						else
						{
							$("#register-submit-btn").prop( "disabled", false );
							$("#registration_error").removeClass('hide');
							$("#registration_error span").html(data.msg);
						}
					});              
            }
    ...
    var handleClockfaceTimePickers = function () {
        ...
        $('#clockface_2_toggle-btn').click(function (e) {
            ...
            $('#shop_close_time').clockface('toggle');
        });

		$('#clockface_2_toggle-btn_start').click(function (e) {
            //alert("ok");
			e.stopPropagation();
			
            $('#shop_open_time').clockface('toggle');
        });
    ...
    var handleFormValidation = function () {
        ...
        form1.validate({
            ...
            submitHandler: function (form) {
				...
				if(!id)
				{
				$.post( api_url + "/admin_role.php", { func:"add_role",role_tile:$("#role_title").val(), parent_role_id:$("#parent_role_id").val()})
					.done(function(data){
						//alert("00"+data);
						data = JSON.parse(data);
						if(data.success)
				...
				{
					$.post( api_url + "/admin_role.php", { func:"edit_role", role_id:id, role_tile:$("#role_title").val(), parent_role_id:$("#parent_role_id").val()})
					.done(function(data){
						//alert("11"+data);
						data = JSON.parse(data);
						if(data.success)
	...
	var handleAdminUserFormValidation = function () {
        ...
        form1.validate({
            ...
            submitHandler: function (form) {
				...
				$.post( api_url + "/admin_user.php", 
					...
					parent_admin_id:$("#parent_admin_id").val()					
					})
					.done(function(data){
						//alert("00"+data);
						data = JSON.parse(data);
	...
	var handleStateFormValidation = function () {
    ...
    var handlePageFormValidation = function () {
    ...
    var handleInfoFormValidation = function () {
        ...
        form1.validate({
            ...
            submitHandler: function (form) {
                $.post( api_url + "/info.php", $('#form_sample_1').serialize())
                .done(function( data ) {
                   console.log(data);
                   data = JSON.parse(data);
                   if(data.success)
    ...
    var handleSliderFormValidation = function () {
            ...
            submitHandler: function (form) {
                ...
                success     : function(data, textStatus, jqXHR){
                    ...
                    {                           
                        ...
                        window.location.href=site_url+"admin/slider.html";       
                    }
                    else
                    {
                        $("#err").html(data.msg);
    ...
    var handleUserFormValidation = function () {
            ...
            submitHandler: function (form) {
                ...
                success     : function(data, textStatus, jqXHR){
                    ...
                    {                           
                        ...
                        window.location.href=site_url+"admin/user.html";       
                    }
                    else
                    {
                        $("#err").html(data.msg);
	...
	var handlePriceFormValidation = function () {
        ...
        form1.validate({
            ...
            submitHandler: function (form) {
				...
				if(!id)
				{
				$.post( api_url + "/sd_vendor_price.php", 
					{ 
					func:"add",
					price_title:$("#price_title").val()
    ...
    var handleBankFormValidation = function () {
    ...
    var handleBillingCycleFormValidation = function () {
        ...
        form1.validate({
            ...
            submitHandler: function (form) {
                ...
                if(!id)
                {
                $.post( api_url + "/sd_billing_cycle.php", 
                    { 
                    func:"add",
                    billing_cycle_name:$("#billing_cycle_name").val(),
                    admin_id: window.sessionStorage.getItem("admin_id")            
                    })
                    .done(function(data){
                        //alert("00"+data);
    ...
    var handlePaymentMethodFormValidation = function () {
        ...
        form1.validate({
            ...
            submitHandler: function (form) {
                ...
                if(!id)
                {
                $.post( api_url + "/sd_payment_method.php", 
                    { 
                    func:"add",
    ...
    var handlePlanFormValidation = function () {
    ...
    var handlePlanTypeFormValidation = function () {
        ...
        form1.validate({
            ...
            submitHandler: function (form) {
                ...
                if(!id)
                {
                $.post( api_url + "/sd_plan_type.php", 
                    { 
                    func:"add",
                    plan_type_name:$("#plan_type_name").val(),
                    admin_id: window.sessionStorage.getItem("admin_id")            
                    })
                    .done(function(data){
                        //alert("00"+data);
    ...
    var handleBillingFormValidation = function () {
        ...
        form1.validate({
            ...
            submitHandler: function (form) {
                ...
                if(!id)
                {
                    var plan_type_ids = new Array();
                    $.each($("input[name='plan_type_ids[]']:checked"), function() {
                      plan_type_ids.push($(this).val());                      
                    });
                ...
                $.post( api_url + "/sd_billing.php", 
                    ...
                    plan_id:$("#plan_id").val(),
                    plan_type_ids:plan_type_ids,
                    amount:$("#amount").val(),
                    payment_method_id:$("#payment_method_id").val(),
                    validity:$("#validity").val(),
                    aadhar:$("#aadhar").val(),
                    billing_cycle_id:$("#billing_cycle_id").val(),
                    bank_id:$("#bank_id").val(),
                    ifsc:$("#ifsc").val(),
                    acc_no:$("#acc_no").val(),
                    cheque_no:$("#cheque_no").val(),
                    agent_name:$("#agent_name").val(),
                    created_by_id: window.sessionStorage.getItem("admin_id"),
                    admin_id: window.sessionStorage.getItem("admin_id"),
                    gst_no: $("#gst_no").val()            
                    })
                    .done(function(data){
	...
	var handleCityFormValidation = function () {
	...
	var handleLocationFormValidation = function () {
        ...
        form1.validate({
            ...
            submitHandler: function (form) {
				...
				if(!id)
				{
				$.post( api_url + "/sd_location.php", 
					{ 
					func:"add",
					location_name:$("#location_name").val(),
					location_pin_code:$("#location_pin_code").val(),
					city_id:$("#city_id").val()
					})
					.done(function(data){
						//alert("00"+data);
	...
	var handleCategoryFormValidation = function () {
				...
				if(!id)
				{
                	$.ajax({
						...
						success: function(data)
						{
							...
							$("#parent_level_2").addClass("hide");
							$("#parent_level_3").addClass("hide");
							success1.show();
							error1.hide();
	...
	var handleVendorFormValidation = function () {
        ...
        var error6 = $('.alert-error', form6);
        var success6 = $('.alert-success', form6);
		
		var form7 = $('#form_sample_7');
        var error7 = $('.alert-error', form7);
        var success7 = $('.alert-success', form7);
		
		var form8 = $('#form_sample_8');
        var error8 = $('.alert-error', form8);
        var success8 = $('.alert-success', form8);
		
		var form9 = $('#form_sample_9');
        var error9 = $('.alert-error', form9);
            ...
            submitHandler: function (form) {
				...
				$.ajax({
					...
					success: function(data)
					{
						...
						$("#form_sample_1 #succ").html(data.msg);
						$(".edit_id").val(data.inserted_id);							
						success1.show();
						error1.hide();
						$(".btn").prop( "disabled", false );
						$(".plz_wait").hide();
					...
					error: function() 
					{
						$("#form_sample_1 #err").html(data.msg);
						success1.hide();
						error1.show();
						$(".btn").prop( "disabled", false );
						$(".plz_wait").hide();	
		...
		form2.validate({
            ...
            submitHandler: function (form) {
				...
				$.ajax({
					url: api_url + "/sd_vendors.php",
					type: "POST",
					data:  new FormData($("#form_sample_2")[0]),						
					contentType: false,
					processData:false,
					success: function(data)
					{
						...
						$("#form_sample_2 #succ").html(data.msg);
						$(".edit_id").val(data.inserted_id);
						$("#uploaded_signature").html('<img src="https://s3.ap-southeast-1.amazonaws.com/sd-prod-101-signature/'+data.vendor_sign+'" width="200">');						
						success2.show();
						error2.hide();
						$(".btn").prop( "disabled", false );
						$(".plz_wait").hide();
					...
					error: function() 
					{
						$("#form_sample_2 #err").html(data.msg);
						success2.hide();
						error2.show();
						$(".btn").prop( "disabled", false );
						$(".plz_wait").hide();	
		...
		form3.validate({
            ...
            submitHandler: function (form) {
				...
				$.ajax({
					url: api_url + "/sd_vendors.php",
					type: "POST",
					data:  new FormData($("#form_sample_3")[0]),						
					contentType: false,
					processData:false,
					success: function(data)
					{
						...
						$("#form_sample_3 #succ").html(data.msg);
						$(".edit_id").val(data.inserted_id);							
						success3.show();
						error3.hide();
						$(".btn").prop( "disabled", false );
					...
					error: function() 
					{
						$("#form_sample_3 #err").html(data.msg);
						success3.hide();
						error3.show();
						$(".btn").prop( "disabled", false );
						$(".plz_wait").hide();	
		...
		form4.validate({
            ...
            submitHandler: function (form) {
				...
				if(!id)
				{
					$("#form_sample_4 #err").html("Please submit vendor details first. Then try to upload Image.");						
                    success1.hide();
                    error1.show();
				}
				else
				{
                    ...
                    $.ajax({
                        url: api_url + "/sd_vendors.php",
                        type: "POST",
                        data:  new FormData($("#form_sample_4")[0]),                        
                        contentType: false,
                        processData:false,
                        success: function(data)
                        {
                            ...
                            $("#form_sample_4 #succ").html(data.msg);
                            $(".edit_id").val(data.inserted_id);
							$("#photos").append('<img src="https://s3.ap-southeast-1.amazonaws.com/sd-prod-101-img/'+data.photo_name+'" style="width:200px; padding:5px;">');                          
                            $("#shop_image").val("");
							success4.show();
                            error4.hide();
                            $(".btn").prop( "disabled", false );
                        ...
                        {
                            alert(data);
                            $("#form_sample_4 #err").html(data.msg);
                            success4.hide();
                            error4.show();
                            $(".btn").prop( "disabled", false );
                            $(".plz_wait").hide();  
		...
		form5.validate({
            ...
            submitHandler: function (form) {
				...
				if(!id)
				{
					$("#form_sample_5 #err").html("Please submit vendor details first. Then try to upload video.");                        
                    success1.hide();
                    error1.show();						
				}
				else
				...
				$.ajax({
					url: api_url + "/sd_vendors.php",
					type: "POST",
					data:  new FormData($("#form_sample_5")[0]),						
					contentType: false,
					processData:false,
					success: function(data)
					{
						...
						$("#form_sample_5 #succ").html(data.msg);
						$(".edit_id").val(data.inserted_id);							
						success5.show();
						error5.hide();
						$(".btn").prop( "disabled", false );
					...
					error: function() 
					{
						$("#form_sample_5 #err").html(data.msg);
						success5.hide();
						error5.show();
						$(".btn").prop( "disabled", false );
						$(".plz_wait").hide();	
		...
		form6.validate({
            ...
            submitHandler: function (form) {
				...
				if(!id)
				{
					$("#form_sample_6 #err").html("Please submit vendor details first. Then try to update other informations.");                        
                    success1.hide();
                    error1.show();  						
				}
				else
				...
				$.ajax({
					url: api_url + "/sd_vendors.php",
					type: "POST",
					data:  new FormData($("#form_sample_6")[0]),						
					contentType: false,
					processData:false,
					success: function(data)
					{
						...
						$("#form_sample_6 #succ").html(data.msg);
						$(".edit_id").val(data.inserted_id);							
						success6.show();
						error6.hide();
						$(".btn").prop( "disabled", false );
					...
					error: function() 
					{
						$("#form_sample_6 #err").html(data.msg);
						success6.hide();
						error6.show();
						$(".btn").prop( "disabled", false );
						$(".plz_wait").hide();	
		...
		form7.validate({
            ...
            submitHandler: function (form) {
				...
				if(!id)
				{
					$("#form_sample_7 #err").html("Please submit vendor details first. Then try to update area information.");                        
                    success7.hide();
                    error7.show();						
				}
				else
				...
				$.ajax({
					url: api_url + "/sd_vendors.php",
					type: "POST",
					data:  new FormData($("#form_sample_7")[0]),						
					contentType: false,
					processData:false,
					success: function(data)
					{
						...
						$("#form_sample_7 #succ").html(data.msg);
						$(".edit_id").val(data.inserted_id);							
						success7.show();
						error7.hide();
						$(".btn").prop( "disabled", false );
					...
					error: function() 
					{
						$("#form_sample_7 #err").html(data.msg);
						success7.hide();
						error7.show();
						$(".btn").prop( "disabled", false );
						$(".plz_wait").hide();	
		...
		form8.validate({
            ...
            submitHandler: function (form) {
				...
				if(!id)
				{
					$("#form_sample_8 #err").html("Please submit vendor details first. Then try to update Product Image.");                        
                    success8.hide();
                    error8.show();						
				}
				else
				...
				$.ajax({
					url: api_url + "/sd_vendors.php",
					type: "POST",
					data:  new FormData($("#form_sample_8")[0]),						
					contentType: false,
					processData:false,
					success: function(data)
					{
						...
						$("#form_sample_8 #succ").html(data.msg);
						$("#edit_id").val(data.inserted_id);
						$("#productPhotos").append('<div class="span3" style="min-height: 200px; border: 1px solid; padding: 5px; margin: 5px;"><img src="https://s3.ap-southeast-1.amazonaws.com/sd-prod-101-img/'+data.product_image+'" style="width:100px; padding:5px;"><br/>'+data.product_name+'<br/>(Rs.'+ data.product_price+'/-)<br/>ID: '+ data.product_id+'</div>');
						$("#product_image").val("");	
						$("#product_price").val("");
						$("#product_name").val("");						
						success8.show();
					...
					error: function() 
					{
						$("#form_sample_8 #err").html(data.msg);
						success8.hide();
						error8.show();
						$(".btn").prop( "disabled", false );
						$(".plz_wait").hide();	
		...
		form9.validate({
            ...
            submitHandler: function (form) {
				...
				if(!id)
				{
					$("#form_sample_9 #err").html("Please submit vendor details first. Then try to update Category.");                        
                    success8.hide();
                    error8.show();						
				}
				else
				...
				$.ajax({
					url: api_url + "/sd_vendors.php",
					type: "POST",
					data:  new FormData($("#form_sample_9")[0]),						
					contentType: false,
					processData:false,
					success: function(data)
					{
						...
						$("#form_sample_9 #succ").html(data.msg);
						$(".edit_id").val(data.inserted_id);							
						success9.show();
						error9.hide();
						$(".btn").prop( "disabled", false );
					...
					error: function() 
					{
						$("#form_sample_9 #err").html(data.msg);
						success9.hide();
						error9.show();
						$(".btn").prop( "disabled", false );
						$(".plz_wait").hide();	
    ...
    return {
        ...
        init: function () {
			...
			if (App.isPage("admin_user_form_validation")) {				
			
                handleAdminUserFormValidation(); // handles form validation samples
            }
			
			if (App.isPage("state_form_validation")) {				
			
                handleStateFormValidation(); // handles form validation samples
            }
			
			if (App.isPage("city_form_validation")) {				
			
                handleCityFormValidation(); // handles form validation samples
            }
			
			if (App.isPage("location_form_validation")) {				
			
                handleLocationFormValidation(); // handles form validation samples
            }
			
			if (App.isPage("category_form_validation")) {				
			
                handleCategoryFormValidation(); // handles form validation samples
            }
			
			if (App.isPage("vendor_form_validation")) {				
			
                handleVendorFormValidation(); // handles form validation samples
            }
			
			if (App.isPage("price_form_validation")) {				
			
                handlePriceFormValidation(); // handles form validation samples
            }
			
            if (App.isPage("bank_form_validation")) {              
            
                handleBankFormValidation(); // handles form validation samples
            }

            if (App.isPage("billing_cycle_form_validation")) {              
            
                handleBillingCycleFormValidation(); // handles form validation samples
            }
            
            if (App.isPage("payment_method_form_validation")) {              
            
                handlePaymentMethodFormValidation(); // handles form validation samples
            }
            if (App.isPage("plan_form_validation")) {              
            
                handlePlanFormValidation(); // handles form validation samples
            }
            if (App.isPage("plan_type_form_validation")) {              
            
                handlePlanTypeFormValidation(); // handles form validation samples
            }

            if (App.isPage("billing_form_validation")) {              
            
                handleBillingFormValidation(); // handles form validation samples
            }

            if (App.isPage("page_form_validation")) {              
            
                handlePageFormValidation(); // handles form validation samples
            }            

            if (App.isPage("info_form_validation")) {              
            
                handleInfoFormValidation(); // handles form validation samples
            }
            if (App.isPage("slider_form_validation")) {              
            
                handleSliderFormValidation(); // handles form validation samples
            }
            if (App.isPage("user_form_validation")) {              
            
                handleUserFormValidation(); // handles form validation samples
            }
...
function permissionWiseNavShowHide()
{
	$.post( api_url + "/admin_role.php", { func:"role_all_permission_list", admin_id:admin_id})
		.done(function(data){	
        		console.log(data);
			data = JSON.parse(data);
			...
			{
				if(!data.permission_list[key]['view'] && !data.permission_list[key]['add'])
				$(".nav_"+data.permission_list[key]['module_id']).remove();
				else if(!data.permission_list[key]['view'])
				{
					$(".nav_view_"+data.permission_list[key]['module_id']).remove();
				}
				else if(!data.permission_list[key]['add'])
				{
					$(".nav_add_"+data.permission_list[key]['module_id']).remove();
				}
			}
		});
}

function checkPermission(admin_id, module_id, role_type)
{
	$.post( api_url + "/admin_role.php", { func:"check_permission", admin_id:admin_id, module_id:module_id, role_type:role_type})
		.done(function(data){
			console.log(data);
			data = JSON.parse(data);
			console.log(data);
